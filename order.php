...
if ($data['code'] == 'ok') {
    ...
    <div class="container">
        <h2 class="success-page__title">Parabéns! A sua encomenda foi aceite!</h2>

        <p class="success-page__message_success">Depois, um operador do nosso call center irá contactá-lo(a) brevemente para confirmar a sua encomenda. Por favor verifique se o seu telemóvel está ligado.</p>

        <h3 class="success-page__text">Por favor verifique a informação que introduziu</h3>

        <div class="list-info">
            <ul class="list-info__list">
                <li class="list-info__item">
                    <span class="list-info__text">Nome e Sobrenome: </span>
                    $name
                </li>
                <li class="list-info__item">
                    <span class="list-info__text">O Telefone: </span>
                    $phone
                </li>
            </ul>
        </div>
        ...
        <p class="success-page__message_fail">
            <a class="success-page__message_fail__link" href="#" onclick="GoBackWithRefresh();return false;">
                Se se enganar a preencher o formulário, por favor volte atrás e preencha-o novamente
            </a>
        </p>
    </div>
</div>
